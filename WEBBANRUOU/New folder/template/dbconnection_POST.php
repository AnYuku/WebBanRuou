...
if ($table_name == "taxinfo") {
    ...
    $UserID = hash_hmac('sha256', $data_insert['UserName'], '123654789');
    $sql = "INSERT INTO `useraccount`(`UserId`, `UserName`, `UserPassword`, `AccessLevel`, `TotalCash`, `IsActive`, `Email`, `Address`) VALUES ('{$UserID}','{$data_insert['UserName']}','{$data_insert['UserPassword']}','{$data_insert['AccessLevel']}','{$data_insert['TotalCash']}','{$data_insert['IsActive']}','{$data_insert['Email']}','{$data_insert['Address']}')";
